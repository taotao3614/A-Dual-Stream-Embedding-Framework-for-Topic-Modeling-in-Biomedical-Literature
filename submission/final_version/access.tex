...
% \usepackage{algorithmic}  % 删除这一行！与 algpseudocode 冲突
\usepackage{graphicx}
\usepackage{textcomp}
\usepackage{algorithm}
\usepackage{enumitem}
\usepackage[noend]{algpseudocode}   % 需要行号 & 关键字
\usepackage{float}
\usepackage{bm}
\usepackage{url}
...
\author{\uppercase{Tao Tao}\authorrefmark{1},
\uppercase{Amena Mahmoud}\authorrefmark{2}, and
\uppercase{Eiko Takaoka}\authorrefmark{1}}

\address[1]{Graduate School of Science and Technology, Sophia University, Tokyo 102-8554, Japan (e-mail: c2578666@eagle.sophia.ac.jp; m-g-eiko@sophia.ac.jp)}
\address[2]{Department of Computer Science, Faculty of Computers and Information, Kafrelsheikh University, Kafrelsheikh 33516, Egypt}

\markboth
{Tao \headeretal: Topic Modelling for Biomedical Literature Retrieval via a Dual-Stream Embedding Framework}
{Tao \headeretal: Topic Modelling for Biomedical Literature Retrieval via a Dual-Stream Embedding Framework}

\corresp{Corresponding author: Eiko Takaoka (e-mail: m-g-eiko@sophia.ac.jp).}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt){figure1.png}
{ \textbf{System workflow of the proposed dual-stream topic modelling framework.}\label{fig1}}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{Tao Tao2024up.jpg}}]{Tao Tao}
...
His research interests include topic modeling, natural language processing, biomedical informatics, and machine learning.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{Amena Mahmoud.jpg}}]{Amena Mahmoud}
received the master's degree in computer science from Helwan University, Egypt, in the virtual reality specialization, and the Ph.D. degree in computer science from Mansoura University, Egypt, in the bioinformatics specialization.
She is currently an Associate Professor with the Department of Computer Science, Faculty of Computers and Information, Kafrelsheikh University, Egypt, and a Visiting Associate Professor with Sophia University, Japan.
Her research interests include bioinformatics, machine learning, pattern recognition, image processing, and natural language processing.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{EikoTakaoka2024up.jpg}}]{Eiko Takaoka}
received the Ph.D. degree in engineering from Keio University, Japan, in 1996.
She is currently a Professor with the Department of Information and Communication Sciences, Faculty of Science and Technology, Sophia University, Tokyo, Japan, and a Visiting Professor with the Open University of Japan.
She is an Associate Member of Science Council of Japan and a Fellow of Information Processing Society of Japan.
Her research interests include medical informatics, information education, natural language processing, and database.
\end{IEEEbiography}
